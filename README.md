...
Competition codebase for FTC Team NB5387 for the INTO THE DEEP season.
...
- `FtcRobotController/` — FTC SDK controller module
- `doc/` — SDK/reference documentation
...
This README intentionally removes FTC template boilerplate and focuses on the team’s implemented architecture and robot capabilities in `TeamCode`.
